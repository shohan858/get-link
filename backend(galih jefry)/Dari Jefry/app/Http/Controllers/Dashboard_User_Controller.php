...
class Dashboard_User_Controller extends Controller
{
    ...
    public function dashboard()
    {
        ...
        return view('Dashboard_User.dashboard')->with(['count_microsite' => $count_microsite, 'limit_microsite' => $limit_microsite]);
    }
    ...
    $visitor = visitorModel::where('id_microsite', 75)
