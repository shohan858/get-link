...
<body>
    ...
    <nav class="navbar bg-body-tertiary shadow">
        ...
        <x-dropdown-link :href="route('logout')"
                ...
                <a href="/logout" class="btn btn-outline-primary rounded-pill btn-large" style="width: 20%">logout</a>
            @else
                <a href="/sesi" class="btn btn-outline-primary rounded-pill btn-large" type="button"
    ...
    <div class="hero_container">
        ...
        <div class="hero_kanan" data-aos="fade-left" data-aos-anchor="#example-anchor" data-aos-offset="500"
            ...
            @foreach ($data_getlink as $item)
            @if ($item->id == 1)
        <img class="__hero_image" src="{{ url('gambar').'/'.$item->image }}" />
        @endif
        @endforeach
        </div>
    </div>
