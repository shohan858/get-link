...
Route::prefix('tagihan')->group(function () {
    ...
    Route::post('/tagihan/{tagihan}/paid', [TagihanController::class, 'update'])->name('tagihan.paid');
    ...
    Route::get('/testing', [TagihanController::class, 'getAllInvoices']);
});
...
Route::middleware(['authadmin'])->group(function () {
    ...
    Route::get('/profile/edit/{id}', [ProfileController::class, 'edit_profile'])->name('profile.edit');
