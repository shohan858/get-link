        ...
        <div class="right">
          <div class="content">
            ...
            <form  action="/sesi/login" method="POST">
              ...
              <a style="margin-left: 275px; color: rgb(129, 128, 125)">atau</a><br>
              <a href="<?php echo e(route('auth.google')); ?>" class="button-outline" style="margin-top: 2%" value="Submit"><i class="fa-brands fa-google"></i> Sign In With Google</a>
...
<?php /**PATH C:\Users\galih agung raharjo\Documents\github\get-link\backend(galih jefry)\Getlink_New\resources\views/sesi/index.blade.php ENDPATH**/ ?>