                ...
                columns: [{
                    ...
                    },  
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            '<button class="katHap" data-id="' + data +
                            '" data-nama="' + full.title +
                            '" onclick="deleteKategori(this)"><i class="fa-solid fa-trash" style="color:#fff;cursor: pointer;"></i></button>' +
                            '<a href="/template/edit/'+data+'"><button class="edit-btn"><i class="fa-solid fa-pen"></i></button></a>' +
                            '<a href="/template/lihat/'+data+'"><button class="detail-btn"><i class="fa-solid fa-eye"></i></button></a>' +
                            '</div>';
                        }
                    },
                ]
