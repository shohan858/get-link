...
Route::middleware(['authadmin'])->group(function () {
    ...
    Route::get('/template/edit/{id}', [AdminController::class, 'edit_template'])->name('edit_template');
    Route::get('/template/lihat/{id}', [AdminController::class, 'lihat_template'])->name('lihat_template');
