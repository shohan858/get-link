                ...
                <div class="pages4-bagi">
                    <div id="prew1" class="anim hidden pages4-kiri">
                        ...
                        <div class="pages4-lamnjut">
                            ...
                            <?php else: ?>
                                <button type="button" id="buat-micro"
                                    class="pages4-lanjutkan button-prevent-multiple-submits" value="1"
                                    style="height:40px">Selesai</button>
                            <?php endif; ?>
                        </div>
                        </form>
...
<?php echo $__env->make('layout.Dashboard_User.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\get_new_2\Getlink_New_GALIH\resources\views/Dashboard_User/pages4.blade.php ENDPATH**/ ?>