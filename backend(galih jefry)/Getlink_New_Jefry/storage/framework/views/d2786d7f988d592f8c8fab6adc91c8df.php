        ...
        <div class="content">
            <div class="pages1-content hidden">
                <div class="anim regu-content-top">
                    <?php if($count_microsite == Auth::user()->batas_microsite): ?>
                ...
                <div class="tenggah">
                    <p class="st"><?php echo e($count_microsite); ?>/<?php echo e(Auth::user()->batas_microsite); ?></p>
                </div>
...
<?php echo $__env->make('layout.Dashboard_user.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\get_new_2\Getlink_New_GALIH\resources\views/Dashboard_User/regular.blade.php ENDPATH**/ ?>