...
<center>
                <?php if($background->type_background == 'color'): ?>
                  <div class="show_microsite" style="background-color: <?php echo e($background->background); ?>">
                <?php else: ?>
                  <div class="show_microsite" style="background-image: url('<?php echo e(asset('gambar/'.$background->background)); ?>')">
                <?php endif; ?>
                    <?php $non_bungkus = ''; ?>
                    <?php $kolom2 = ''; ?>
...
</html><?php /**PATH C:\Users\galih agung raharjo\Documents\github\get-link\backend(galih jefry)\Getlink_New_GALIH\resources\views/microsite/index.blade.php ENDPATH**/ ?>