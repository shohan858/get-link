                ...
                <div class="anim dashboard-content-isi">
                    <div class="content-atas">
                        <div class="dashboard-teks">
                            ...
                            <p class="dashboard-nama"><?php echo e(Auth::user()->name); ?></p>
                            <p class="dashboard-p">
                    ...
                    <div class="content-bawah">
                        <div class="dashboard-card">
                            ...
                            <div class="dashboard-micro">
                                <img src="assets/img/Vector (15).png" alt="" />
                                <p class="pengunjung-1">Microsite dibuat</p>
                                <p class="pengunjung-p"><?php echo e(Auth::user()->jumlah_microsite); ?>/<?php echo e(Auth::user()->batas_microsite); ?> Microsite</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layout.Dashboard_user.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\galih agung raharjo\Documents\github\get-link\backend(galih jefry)\Getlink_New_GALIH\resources\views/Dashboard_User/dashboard.blade.php ENDPATH**/ ?>