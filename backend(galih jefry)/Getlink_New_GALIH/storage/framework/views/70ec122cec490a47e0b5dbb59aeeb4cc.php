                ...
                <table class="table table-striped">
                    ...
                    <tbody class="text-center">
                        <tr>
                            ...
                            <td><img class="bg-primary" src="<?php echo e(url('gambar').'/'.$item->image); ?>" width="15%" height="15%" alt=""></td>
                            <td>
                ...
                <section id="judul2">
                    <div class="short_link">
                      <?php $__currentLoopData = $data_getlink; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($item->id == 2): ?>
                        <div class="sl_kanan">
                          <img src="<?php echo e(asset('uploads/' . $item->image )); ?> " class="img-fluid" alt="" />
                        </div>
                        <?php endif; ?>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\galih agung raharjo\Documents\github\get-link\backend(galih jefry)\Getlink_New\resources\views/admin/landing_page/judul2.blade.php ENDPATH**/ ?>