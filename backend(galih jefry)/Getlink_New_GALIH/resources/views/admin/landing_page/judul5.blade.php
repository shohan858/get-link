                                ...
                                <form action="update_landing_page/{{ $item->id }}" method="POST"
                                    ...
                                    <div class="input-group mb-3 mt-3">
                                        <input type="text" class="form-control" name="title"
                                            value="{{ $item->title }}" placeholder="Title 1" aria-label="Title 1"
                                    ...
                                    @if ($item->subtitle != null)
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" name="subtitle"
                                                value="{{ $item->subtitle }}" placeholder="Subtitle 1"
                                        ...
                                        <form action="update_landing_page/{{ $item->id }}" method="POST"
                                            ...
                                            <td>
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="title"
                                                        value="{{ $item->title }}" placeholder="Title 1"
                            ...
                            <div class="CMS_kanan">
                                ...
                                @foreach ($data_getlink as $item)
                                    @if ($item->id == 6)
                                        <div class="CMS_li">
                                            <img class="CMS_img"
                                                src="{{ asset('assets_landing_page/img/Vector (1).png') }} "
                                                alt="">
