...
<body>
  ...
  <nav class="navbar bg-body-tertiary shadow">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">
        <img src="<?php echo e(asset('assets_landing_page/img/logo-text2.png')); ?> " alt="Logo" width="120" class="d-inline-block align-text-top ms-5">
      </a>
      <?php if(Auth::check()): ?>
  ...
  <div class="banner_container">
    ...
    <div class="banner_kiri" style="margin-top: 100vh;"> 
      <img class="banner_gambar-kiri" src="<?php echo e(asset('assets_landing_page/img/woman in online meetings.png')); ?> " alt="">
  ...
  <section style="margin-top: 170px; margin-bottom: 50px;">
    ...
    <div class="CMS">
      ...
      <?php $__currentLoopData = $data_getlink; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($item->id == 6): ?>
        <div class="CMS_li">
          <img class="CMS_img" src="<?php echo e(asset('assets_landing_page/img/Vector (1).png')); ?> " alt="">
  ...
  <div class="almost_footer">
      ...
      <div class="info">
        <div class="satu">
          <div class="image_footer me-2">
                  <img src="<?php echo e(asset('assets_landing_page/img/dunia.png')); ?>" alt="Logo" class="bg-white rounded-circle">
                </div>
          <p>Jl.Anggrek No.200 Cepokomulyo <br> Kepanjen, Malang</p>
        </div>
        <div class="dua">
          <div class="image_footer me-2">
                  <img src="<?php echo e(asset('assets_landing_page/img/telpon2.png')); ?>" alt="Logo" class="bg-white rounded-circle">
                </div>
          <p>+62 851-7332-1203</p>
        </div>
        <div class="tiga">
                          <div class="image_footer me-2">
                  <img src="<?php echo e(asset('assets_landing_page/img/pesan.png')); ?>" alt="Logo" class="bg-white rounded-circle">
                </div>
    ...
    <div class="box_foot_kanan">
      ...
      <img class="foot_lokasu_img" src="<?php echo e(asset('assets_landing_page/img/map2.png')); ?>" alt="" style="width:300px;border-radius: 5px;"></a>
    </div>
          <img class="garis_foot" src="<?php echo e(asset('assets_landing_page/img/Line 1.png')); ?>" alt="">
    <div class="foot_footer">
      ...
      <div class="social_media">
        <div class="social_box"><img src="<?php echo e(asset('assets_landing_page/img/Vector (2).png')); ?>" alt=""></div>
        <div class="social_box"><img src="<?php echo e(asset('assets_landing_page/img/Vector (3).png')); ?>" alt=""></div>
        <div class="social_box"><img src="<?php echo e(asset('assets_landing_page/img/Vector (4).png')); ?>" alt=""></div>
        <div class="social_box"><img src="<?php echo e(asset('assets_landing_page/img/Vector (5).png')); ?>" alt=""></div>
      </div>
    </div>
  </div>
...
</html><?php /**PATH D:\FrondEnd\Getlink_New\resources\views/Home/landing_page.blade.php ENDPATH**/ ?>