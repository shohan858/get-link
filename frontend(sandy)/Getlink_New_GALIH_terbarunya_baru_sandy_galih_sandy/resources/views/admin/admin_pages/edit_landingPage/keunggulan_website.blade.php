    ...
    <div class="adkw">
        ...
        <div class="overf">
            <table class="data">
                ...
                <tr>
                    <td colspan="5">
                        <form class="bottomtab" id="kw_edit1" method="POST" action="update_landing_page/{{ $item->id }}"
                ...
                <tr>
                    <td colspan="5">
                        <form class="bottomtab" id="kw_edit2" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form class="bottomtab" id="kw_edit3" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form class="bottomtab" id="kw_edit4" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form class="bottomtab" id="kw_edit5" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form class="bottomtab" id="kw_edit6" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
