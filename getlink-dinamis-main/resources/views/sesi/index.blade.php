  ...
  <div class="container py-5 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
      <div class="col-md-8 col-lg-7 col-xl-6">
        <img src="https://img.freepik.com/free-vector/desktop-smartphone-app-development_23-2148683810.jpg?size=338&ext=jpg&ga=GA1.1.447178260.1676261222&semt=sph" width="100%"
      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        <form  action="/sesi/login" method="POST">
          ...
          <a class="btn btn-primary text-primary btn-lg btn-xl" style="background-color: white" href="{{ route('auth.google') }}"
            role="button">
