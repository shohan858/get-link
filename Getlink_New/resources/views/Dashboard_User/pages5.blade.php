              ...
              <div class="pages5-komponen-text">
                <div class="pages5-komponen-text-kiri">
                  <button class="btn-drag">
                    <img
                      class="pages5-isi"
                      src="{{ asset('assets/img/Group 71.png') }}"
                      alt=""
                    />
                  </button>
                  <img
                    class="pages5-isi"
                    src="{{ asset('assets/img/🦆 icon _media image_.png') }}"
                    alt=""
                  />
                ...
                <div class="pages5-komponen-text-kanan">
                  <button id="btnSwitch" class="btn-switch">
                    <img
                      class="pages5-isi"
                      src="{{ asset('assets/img/Group 68 (1).png') }}"
                      alt=""
                    />
                  </button>
                  <button id="del1" class="btn-trash">
                    <img
                      class="pages5-isi"
                      src="{{ asset('assets/img/🦆 icon _trash_.png') }}"
                      alt=""
                    />
                  </button>
                  <div class="drop-3dot">
                  ...
                  <button id="dropdown-btn-0" class="btn-drop">
                    <img
                      class="pages5-isi"
                      src="{{ asset('assets/img/Vector (7).png') }}"
                      alt=""
                    />
                  </button>
                </div>
            ...
            <div id="pages5Kom2" draggable="true" class="pages5-komponen-2">
              <div class="pages5-komponen-text">
                <div class="pages5-komponen-text-kiri">
                  ...
                  <img
                    class="pages5-isi"
                    src="{{ asset('assets/img/🦆 icon _edit pencil_.png') }}"
                    alt=""
                  />
            ...
            <div class="pages3-bungkus-kanan">
              <center>
                ...
                <div id="div1" class="template1" style="display: none">
                  <img
                    src="{{ asset('assets/preview-template/img/rai.png') }}"
                    alt=""
                    class="gambar1"
                  />
                  ...
                  <div class="bungkusbunderan">
                    <div class="elipsetemplate1">
                      ...
                      <img
                        src="{{ asset('assets/preview-template/img/ig.png') }}"
                        alt=""
                        class="ikon"
                      />
                    </div>
                    <div class="elipsetemplate1">
                      <p class="sembarang">p</p>
                      <img
                        src="{{ asset('assets/preview-template/img/twit.png') }}"
                        alt=""
                        class="ikon1"
                      />
                    </div>
                    <div class="elipsetemplate1">
                      <p class="sembarang">p</p>
                      <img
                        src="{{ asset('assets/preview-template/img/fb.png') }}"
                        alt=""
                        class="ikon"
                      />
                    </div>
                    <div class="elipsetemplate1">
                      <p class="sembarang">p</p>
                      <img
                        src="{{ asset('assets/preview-template/img/yt.png') }}"
                        alt=""
                        class="ikon1"
                      />
                    </div>
                    <div class="elipsetemplate1">
                      <p class="sembarang">p</p>
                      <img
                        src="{{ asset('assets/preview-template/img/tiktod.png') }}"
                        alt=""
                        class="ikon"
                      />
                    </div>
                  ...
                  <div class="template1-kolom">
                    <img
                      src="{{ asset('assets/preview-template/img/ytred.png') }}"
                      alt=""
                      style="margin-top: 18%"
                    />
                  </div>
