...
<body>
  ...
  <nav class="navbar bg-body-tertiary shadow">
    <div class="container-fluid">
      ...
      @endif
      @else
      <a href="/sesi" class="btn btn-outline-primary rounded-pill" type="button" style="width: 100px">Login</a>
      @endif
    </div>
  </nav>
    ...
    <div class="hero_kiri" data-aos="fade-right">
      ...
      <form id="form_link" method="POST" action="">
        ...
        <label id="tampil_link">
          <input name="input_link" id="input_link" class="__hero_input" type="text" placeholder="Masukkan Link Asli" /        <button id="button_link" class="__hero_button" type="submit">
          ...
          <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
            <div class="row justify-content-evenly">
              ...
              <div class="col-4 col-sm-3 col-md-2">
                <img class="img-fluid mx-auto d-block" src="{{ asset('gambar/' . $item->image) }}" alt="">
              </div>
              @endforeach
            </div>
          </div>
  ...
  <script>
    ...
    var labelasli = document.getElementById("input_link");
    btnCustom.addEventListener("click", function(event) {
      ...
      if (customHide.style.display === "none") {
        ...
        labelasli.textContent = "Masukkan Link Asli";
        customHide.style.display = "flex";
      } else {
        customShow.classList.remove('custom-tampil');
        labelasli.textContent = "Masukkan Link ";
