        ...
        <div class="content">
            <div class="lang-content hidden">
                ...
                <div class="pages2-bagi">
                    <div id="prew1" class="anim hidden pages2-kiri">
                        ...
                        <div class="pages2-isi">
                            ...
                            <div class="pages2-kategori">
                                ...
                                @foreach ($kategori as $item)
                                    <button class="pages2-button2 btn-kategori"
                                        ...
                                        <img src="{{ url('microsite/kategori/' . $item->icon) }}" alt=""
                            ...
                            <div class="pages2-lanjut">
                                ...
                                <div class="btnlamnjut">
                                    <a href="/regular" class="pages3-lanjutkan">
                                        <i class="fa-solid fa-chevron-left"></i>
                                        Kembali
                                    </a>
                                    <button class="pages2-lanjutkan submit-button">
                                        Lanjutkan
            ...
            button.addEventListener("click", function() {
                if (button !== activeBtn) { // jika button tidak sedang aktif (ditekan)
                    if (activeBtn !== null) { // jika ada button yang sedang aktif sebelumnya
                        inactiveColor = activeBtn.getAttribute(
                            "data-color"); // simpan warna dari button tidak aktif sebelumnya
