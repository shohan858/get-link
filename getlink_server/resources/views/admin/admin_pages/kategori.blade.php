...
<style type="text/css">
    ...
    <script>
        ...
        '<button class="edit-btn" onclick="editKategori(' + data + ')"><i class="fa-solid fa-pen"></i></button>';
                        }
                    },
                ]
            });
      ...
      <div id="edit-kategori-modal" class="modal">
        <div class="modal-content-kategori">
            ...
            <div class="modal-body-kategori">
                <form id="formTambahKategori" action="" 
                enctype="multipart/form-data" method="POST" style="margin: 15px">
                @csrf
                @method('put')
                {{-- @method('put') --}}
                    ...
                    <div class="collab">
                        ...
                        <input type="color" id="edit-kategori-color" name="color" required class="botImg"style="margin-top: 0%;margin-bottom: 3%;width:10%">
                    </div>
                    <div class="collab">
                        <label for="sl_custmMsg" class="label-gambar">Masukkan Icon</label>
                        <div class="botImg" style="margin-top:10%;border:none">
                        <input type="file" id="edit-kategori-icon" name="icon" class="dropify" data-height="200" style="width: 300px;"/>
                        </div>
                    </div>
                    ...
                    <div class="collab">
                        ...
                        <div class="botImg" style="margin-top:10%;border:none">
                            ...
                            <button style="cursor: pointer" type="button" id="sl_upBtn" class="btn-gam">Pilih
                                file</button> --}}
                        <input type="file" name="icon" class="dropify" data-height="200" style="width: 300px;" />
