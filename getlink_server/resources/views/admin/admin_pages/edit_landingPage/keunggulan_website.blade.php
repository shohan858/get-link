        ...
        <div class="overf">
            <table class="data">
                ...
                <tr>
                    ...
                    <td>{{ $item->title }}</td>
                    <td>{{ $item->subtitle }}</td>
                    <td><img style="background: #1a2474" src="{{ url('gambar').'/'.$item->image }}" width="50%" height="50%" alt="not found"></td>
                    <td>
                ...
                <tr>
                    <td colspan="5">
                        <form style="margin-top: -5%" class="bottomtab" id="kw_edit1" method="POST" action="update_landing_page/{{ $item->id }}"
                            ...
                            <div class="botSj">
                                <input type="text" name="subtitle" value="{{ $item->subtitle }}"  id="" class="SjSubjudu"
                                    placeholder="Masukkan sub judul">
                            </div>
                            <div class="botSj" style="width:93%;padding-right:3%">
                                <label for="" class="SjSubjudu" style="background: none;text-align:left;float:left;margin-bottom:-2%">Masukkan Gambar</label>
                ...
                <tr>
                    <td colspan="5">
                        <form style="margin-top: -5%" class="bottomtab" id="kw_edit2" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form style="margin-top: -5%" class="bottomtab" id="kw_edit3" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form style="margin-top: -5%" class="bottomtab" id="kw_edit4" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form style="margin-top: -5%" class="bottomtab" id="kw_edit5" method="POST" action="update_landing_page/{{ $item->id }}"
                    enctype="multipart/form-data">
                    @csrf
                            <div class="botHead">
                                <h1 class="both1">Edit Data</h1>
                ...
                <tr>
                    <td colspan="5">
                        <form style="margin-top: -5%" class="bottomtab" id="kw_edit6" method="POST" action="update_landing_page/{{ $item->id }}"
