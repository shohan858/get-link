        ...
        <div class="lang-content hidden">
            <div class="page2-btnprev">
                <button class="pages5-tambah-prew">
                    preview ...
                    {{-- <img loading="lazy" src="{{ asset('assets/img/Group 68 (1).png') }}" alt="" /> --}}
                    <i loading="lazy" class="fa-solid fa-mobile-screen"></i>
                </button>
            </div>
            <div class="pages4-bagi">
                <div id="prew1" class="anim hidden pages4-kiri">
                    ...
                    <div class="pages4-lamnjut">
                        <a href="{{ url()->previous() }}" class="pages4-lanjutkan">
                            <i loading="lazy" class="fa-solid fa-chevron-left"></i>
                            Kembali
                        </a>
                        <button type="button" id="buat-micro" class="pages4-lanjutkan" value="1" style="height:40px">
                            Selesai
                            <i loading="lazy" class="fa-solid fa-chevron-right"></i>
                        </button>
                    </div>
                    </form>
                </div>
                <div id="prew2" class="pages4-kanan">
                    <div class="anim hidden pages4-kanan-bung">
                        <div loading="lazy" class="kanan-bungkus" id="kanan-bungkus">

                        </div>
                    </div>
                    <div class="pages3-lamnjut-prew">
                        <a style="margin: 0;" href="{{ url()->previous() }}" class="pages4-lanjutkan">
                            <i class="fa-solid fa-chevron-left"></i>
                            Kembali
                        </a>
                        <button style="margin: 0;" type="button" id="buat-micro" class="pages4-lanjutkan" value="1" style="height:40px">
                            Selesai
...
success: function(response) {
var url =
"{{ url('rubah_microsite/:id_kategori/:id_template/:id_microsite') }}";
url = url.replace(':id_template', Param2);
url = url.replace(':id_kategori', Param1);
url = url.replace(':id_microsite', response.data.id);
window.location.href = url;
