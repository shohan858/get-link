    ...
    <div class="modal-content">
        ...
        <form class="sl_form" id="update_shotlink">
            <div class="bungkus-hide">
                <input class="sl_text" type="text" id="inputSL_edit" value="{{ $item->link }}" style="color:dimgray; background-color:rgb(212, 204, 204);" name="link_shortlink" placeholder="Tautan panjang" readonly>
            ...
            <div class="" style="display: flex">
                ...
                <button id="SlEdit_kirim" data-id="{{ $index }}" class="btn_msSL" type="submit">Edit</button>
            </div>
        </form>
            ...
            <div class="bungkus-hide">
                ...
                <div class="custom-Link-2">
                    <div class="custom-hide-2" style="display: none">
                        <p class="text-custom">GetLink.id/ </p>
                        <input type="text" name="custom_sh" id="value_custom" class="input-hide" placeholder="custom-link">
                    </div>
        ...
        if (validateLink(link)) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    iziToast.success({
                        title: 'Link Berhasil Dipendekan',
                        position:'topCenter',
                ...
                error: function() {
                    iziToast.warning({
                        title: 'Form link tidak boleh mengandung spasi atau link yang anda masukkan sudah terdaftar',
                        position:'topCenter',
