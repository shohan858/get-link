                ...
                <div class="anim sl-content-isi">
                    ...
                    <p class="emptyP">Anda belum membuat microsite</p>
                        ...
                        <div class="table-scroll">
                            <table class="data">
                                ...
                                @foreach ($data as $index => $row)
                                    <tbody>
                                        <tr class="search-shortlink" data-nama="{{ strtolower($row->link) }}"
                                            data-name="{{ strtolower(config('app.url') . '/g' . $row->code) }}">

                                            <td><?= $nomor++ ?></td>
                                            <td class="teks">{{ $row->link }}</td>
                                            <td class="teks" id="copy-text">{{ config('app.url') . '/' . $row->code }}
                                            </td>
                                            <td>

                                                <div class="aksi-wrapper">

                                                    <button onclick="copyText('{{ config('app.url') . '/' . $row->code }}')"
                                                        style="margin-right:5px; margin-bottom: 3px;" class="copy-btn">
                                                        <i class="fa-regular fa-copy" style="color:#fff;"></i>
                                                    </button>

                                                    <button
                                                        onclick="openModaledit({{ $index }}, {{ $row->id }})"
                                                        style="margin-right:5px; margin-bottom: 3px;" class="edit-btn">
                                                        <i class="fa-solid fa-pen" style="color:#fff;"></i>
                                                    </button>

                                                    <button style="margin-right:5px;" class="katHap" data-id=""
                                                        data-nama="" onclick="openDelModal({{ $index }})">
                        ...
                        <form class="bottomtab" action="" id="sl_edit" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="botJud">
                                <input type="text" name="title" value="" placeholder="Title 1" id=""
            ...
            <div class="del-conmo">
                ...
                <div class="del-bungkus-hapusbutton">
                    ...
                    <form action="/shortlink_delete/{{ $item->id }}" method="post">
                        @csrf
                        @method('DELETE')
                        <button id="btnTrash" class="del-hapus-button" onclick="deleteItem({{ $index }})"
            ...
            <div class="modal-content">
                ...
                <form class="sl_form" id="update_shotlink">
                    <div class="bungkus-hide">
                        <input class="sl_text" type="text" id="inputSL_edit" value="{{ $item->link }}"
                            name="link_shortlink" placeholder="Tautan panjang">
                        ...
                        <div id="custom-link{{ $index }}" class="custom-Link">
                            <div id="custom-hide{{ $index }}" class="custom-hide" style="display: none">
                                ...
                                <input type="text" name="editsh" id="sleditcustom" class="input-hide"
                                    placeholder="custom-link">
                            </div>
                            <div id="custom_link{{ $index }}" class="custom-show">
                                Atau gunakan
                                <a id="btn-custom" onclick="customHide({{ $index }})" class="btn-custom"
                                    href="#"> custom link</a>
                                .
                            </div>
                            <div style="display: none;" id="default_link{{ $index }}" class="custom-show">
                                Atau gunakan
                                <a id="btn-custom" onclick="defaultHide({{ $index }})" class="btn-custom"
                                    href="#"> Default link</a>
                                .
                            </div>
                        </div>
                    ...
                    <div class="" style="display: flex">
                        <button id="" onclick="close_modaledit({{ $index }})" class="bat"
                            type="reset">Batal</button>
                        <button id="SlEdit_kirim" data-id="{{ $index }}" class="btn_msSL"
                ...
                <div class="bungkus-hide">
                    ...
                    <div class="custom-Link-2">
                        <div class="custom-hide-2" style="display: none">
                            <p class="text-custom">GetLink.id/ </p>
                            <input type="text" name="buat" id="value_custom" class="input-hide"
                                placeholder="custom-link">
                        </div>
