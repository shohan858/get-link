        ...
        <form id="form_link" method="POST" action="">
          ...
          <div class="custom-Link">
            ...
            <div class="custom-show"><B>
                Gunakan mode<a id="btn-custom" class="btn-custom" style="color: #1a2474;" href="">custom link</a> </B>
              .
            </div>
          </div>
        </form>
      ...
      if (validateLink(link)) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            swal.fire({
              icon:'success',
              title:'Tautan Berhasil Diperpendek',
              timer:'1500',
            });
          ...
          error: function() {
            iziToast.warning({
              title: 'Form link mengandung spasi atau link custom yang anda masukkan sudah terdaftar',
              position: 'topCenter',
              timeout: 2000,
            });
          }
        ...
        iziToast.warning({
              title: 'Link Yang Anda Masukkan Tidak Valid',
              position: 'topCenter',
              timeout: 2000,
            });
        return;
