        ...
        @if ($item->id == 4)
            <div class="adsh2">
                ...
                <div class="button-kanan">
                    <button id="" onclick="preview()" class="button2"><i class="fa-regular fa-eye"></i>
                        Preview</button>
                </div>
                ...
                <div class="gl_bawah">
                    <table class="data">
                        ...
                        <tr>
                            <td>{{ $item->title }}</td>
                            <td>{{ $item->subtitle }}</td>
                            <td><img src="{{ url('gambar') . '/' . $item->image }}" width="50px" height="50px" alt="not found">
                            </td>
                            <td>
                    ...
                    <form class="bottomtab" action="update_landing_page/{{ $item->id }}" id="mic2_edit" method="POST"
                        ...
                        <div class="botJud">
                            <input type="text" name="title" value="{{ $item->title }}" placeholder="Title 1"
                                id="" class="inputJud" placeholder="Masukkan judul">
                        </div>
                        <div class="botSj">
                            <input type="text" name="subtitle" value="{{ $item->subtitle }}" placeholder="Subtitle 1"
