                ...
                <div class="botChart">
                    <div class="tahunth">
                        <select class="sy" id="year" onchange="updateChart()">
                            <option class="as" value="2020">{{ date('Y') - 2 }}</option>
                            <option value="2021" selected>{{ date('Y') - 1}}</option>
                            <option value="2022">{{ date('Y') }}</option>
                        </select>
                ...
                <div class="botChart">
                    <div class="tahunth">
                        <select class="sy" id="yearPen" onchange="updateChart2()">
                            <option class="as" value="Pen2020">{{ date('Y') - 2 }}</option>
                            <option value="Pen2021">{{ date('Y') - 1 }}</option>
                            <option value="Pen2022" selected>{{ date('Y') }}</option>
                        </select>
                ...
                <div class="botChart">
                    <div class="tahunth">
                        <select class="sy" id="yearLan" onchange="updateChart3()">
                            <option class="as" value="Lan2020">{{ date('Y') - 2 }}</option>
                            <option value="Lan2021">{{ date('Y') - 1 }}</option>
                            <option value="Lan2022" selected>{{ date('Y') }}</option>
                        </select>
