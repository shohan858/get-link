...
<body>
  ...
  <nav class="navbar bg-body-tertiary shadow">
    <div class="container-fluid">
      ...
      <a href="/logout" class="btn btn-outline-primary ms-auto rounded-pill me-5 btn-large" style="width: 10%">logout</a>
      @else
      <a href="/sesi" class="btn btn-outline-primary ms-auto rounded-pill me-5 btn-large" type="button" style="width: 10%">Login</a>
      @endif
    </div>
  </nav>
