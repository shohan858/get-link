<nav>
    <div class="navbar navAni">
      <div class="navbar-kiri">
        ...
        <button class="button-side">
          ...
          <span class="navbar-menu">
            <i id="bars" style="color: #fff" class="fa-solid fa-bars"></i>
          </span>
        </button>
      ...
      <a href="<?php echo e(url('logout')); ?>" class="navbar-upgrade">
        Logout
      </a>
      </div>
    </div>
  </nav>
<?php /**PATH D:\get_new_2\Getlink_New_GALIH_terbarunya_baru\resources\views/layout/Dashboard_user/_nav.blade.php ENDPATH**/ ?>