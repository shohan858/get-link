...
@if (($item->id == 4))
    <div class="adsh2">
        ...
        <form action="update_landing_page/{{ $item->id }}" method="POST" enctype="multipart/form-data" class="bottomtab" id="mic2_edit">
            @csrf
            <div class="botHead">
                <h1 class="both1">Edit Data</h1>
            </div>
            <div class="botJud">
                <input type="text" name="title" value="{{ $item->title}}" id="" class="inputJud" placeholder="Masukkan judul">
            </div>
            <div class="botSj">
                <input type="text" name="subtitle" value="{{ $item->subtitle }}" id="" class="SjSubjudu" placeholder="Masukkan sub judul">
            </div>
            <div class="botImg">
