...
<html lang="en">
  <head>
    ...
    <!-- My Style -->
    <link rel="stylesheet" href="<?php echo e(asset('assets_sesi/css/style.css')); ?>" />
  ...
  <body>
    ...
    <div class="login_pages">
        <div class="logKanan">
            <img class="logBackKan" src="<?php echo e(asset('assets_sesi/images/group.png')); ?>" alt="">
            <img class="logimgKan" src="<?php echo e(asset('assets_sesi/images/Diet.png')); ?>" alt="image not found">
        </div>
        <div class="logKiri">
            <div class="logtopKir">
                <img class="logSimKir" src="<?php echo e(asset('assets_sesi/images/logos.png')); ?>" alt="">
            ...
            <div class="logformKir">
                <form action="/sesi/login" method="POST" style="width: 100%">
                    ...
                    <input class="formPass" type="password" name="password" id="lname" placeholder="Masukkan password">
...
<?php /**PATH D:\get_new_2\Getlink_New_GALIH_terbarunya_baru\resources\views/sesi/index.blade.php ENDPATH**/ ?>