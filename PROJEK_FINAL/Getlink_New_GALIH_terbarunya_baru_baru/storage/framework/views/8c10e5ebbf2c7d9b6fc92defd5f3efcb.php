<?php $__env->startSection('konten'); ?>
        ...
        <div class="content">
            <div class="pages1-content hidden">
                <div class="anim regu-content-top">
                    <?php if(Auth::user()->jumlah_microsite === $limit_microsite): ?>
                ...
                <div class="tenggah">
                    <div class="" style="display: flex">
                        <div class="">
                            <p class="st" style="width: auto;border:none;font-weight:300;font-size:14px;line-height: 16.41px;color:#A5A5A5">
                                Jumlah Microsite Saya
                            </p>
                        </div>
                        <div class="" style="margin-left: 5px">
                            <p class="st"><?php echo e(Auth::user()->jumlah_microsite); ?>/<?php echo e($limit_microsite); ?></p>
                        </div>
                    </div>
                </div>
                <?php $__currentLoopData = $my_microsite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="anim content-isi-regu search-microsite" data-nama="<?php echo e(strtolower($item->name)); ?>">
                        <div class="content-kiri-regu">
                            <div class="content-box"><img src="<?php echo e(url('gambar/' . $item->icon)); ?>" alt=""></div>
                            <div class="box-text">
                                <p class="nama-microsite"><?php echo e($item->name); ?></p>
                                <a class="link-microsite"><?php echo e(env('APP_URL')); ?>/microsite/<?php echo e($item->link); ?></a>
                        ...
                        <div class="content-kanan">
                            ...
                            <a href="rubah_microsite/<?php echo e($item->id_kategori); ?>/<?php echo e($item->id_template); ?>/<?php echo e($item->id); ?>"
                                class="content-crud">
    ...
    <script>
        function copyToClipboard(link) {
            ...
            input.value = '<?php echo e(env('APP_URL')); ?>/microsite/' + link;
...
<?php echo $__env->make('layout.Dashboard_user.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\get_new_2\Getlink_New_GALIH_terbarunya_baru\resources\views/Dashboard_User/regular.blade.php ENDPATH**/ ?>