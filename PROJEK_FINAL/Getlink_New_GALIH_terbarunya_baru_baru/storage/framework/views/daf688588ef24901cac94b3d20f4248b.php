            ...
            <div class="pages4-bagi">
                <div id="prew1" class="anim hidden pages4-kiri">
                    ...
                    <div class="pages4-lamnjut">
                        <a href="<?php echo e(url()->previous()); ?>" class="pages4-lanjutkan">Kembali</a>
...
$(document).ready(function() {
    $(document).on('click', '#buat-micro', function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo e(url('cek_link_unik')); ?>",
            dataType: 'json',
            headers: {
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(url('buatmicrosite/nambah_microsite')); ?>",
                        dataType: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        ...
                        data: formData,
                        success: function(response) {
                            var url = "<?php echo e(url('rubah_microsite/:id_kategori/:id_template/:id_microsite')); ?>";
...
<script>
    function generateHTML() {
        ...
        var data = <?php echo json_encode($komponen, 15, 512) ?>;
        var background = <?php echo json_encode($background, 15, 512) ?>;
...
<?php echo $__env->make('layout.Dashboard_User.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\get_new_2\Getlink_New_GALIH_terbarunya_baru\resources\views/Dashboard_User/pages4.blade.php ENDPATH**/ ?>