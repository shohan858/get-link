    ...
    <div id="add_modal_template" class="modal">
        <div class="modal-content-template" style="">
            ...
            <div class="modal-body-template">
                <form id="formTambahKategori" method="POST" action="<?php echo e(route('tambah_template')); ?>" style="margin: 15px"enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="" style="display: flex;color:grey">
                            <div class="" style="display: block;margin-right: 20%">
                                <?php $__currentLoopData = $komponen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komponens): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input type="checkbox" name="id_komponen[]" value="<?php echo e($komponens->id); ?>" id="option<?php echo e($komponens->id); ?>">
                                    <label for="option<?php echo e($komponens->id); ?>"> <?php echo e($komponens->name); ?></label><br>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layout.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\get_new_2\Getlink_New_GALIH_terbarunya_baru\resources\views/admin/admin_pages/template.blade.php ENDPATH**/ ?>