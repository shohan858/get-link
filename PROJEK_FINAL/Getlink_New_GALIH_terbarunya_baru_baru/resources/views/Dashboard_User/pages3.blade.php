                ...
                <div id="prew1" class="pages3-kiri anim hidden">
                    ...
                    <div class="kiri-bungkus">
                        <div class="pages3-bungkuscard">
                            ...
                            <button id="btn-{{ $item->id }}" data-id="{{ $item->id }}" value="1" class="pages3-card1 btn-template">
                                <img class="card-img" src="{{ asset('microsite/template_image/' . $item->image) }}" alt="gambar {{ $item->title }}" />
