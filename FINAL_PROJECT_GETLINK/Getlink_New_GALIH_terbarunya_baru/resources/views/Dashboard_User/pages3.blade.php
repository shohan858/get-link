        ...
        <div class="content">
            <div class="lang-content hidden">
                    ...
                    <div id="prew1" class="pages3-kiri anim hidden">
                        ...
                        <div class="kiri-bungkus">
                            <div class="pages3-bungkuscard">
                                {{-- <button id="btn-1" class="pages3-card1">
                <img
                  class="card-img"
                  src="{{ asset('assets/img/Group 86.png') }}"
                  alt="card"
                />
              ...
              <button id="btn-2" class="pages3-card2">
                <img
                  class="card-img"
                  src="{{ asset('assets/img/Group 89.png') }}"
                  alt="card"
                />
                <div class="pages3-container">
              ...
              <button id="btn-3" class="pages3-card3">
                <img
                  class="card-img"
                  src="{{ asset('assets/img/Group 90.png') }}"
                  alt="card"
                />
                <div class="pages3-container">
              ...
              <button id="btn-4" class="pages3-card4">
                <img
                  class="card-img"
                  src="{{ asset('assets/img/Group 88.png') }}"
                  alt="card"
                />
                <div class="pages3-container">
              ...
              <button id="btn-5" class="pages3-card5">
                <img
                  class="card-img"
                  src="{{ asset('assets/img/Group 91.png') }}"
                  alt="card"
                />
                <h4 class="pages3-tulis">Portofolio</h4>
                                ...
                                {{-- @foreach ($template as $item)
                                    <button id="btn-{{ $item->id }}" data-id="{{ $item->id }}" value="1"
                                        class="btn-template woyy pages3-card{{ $item->id }} ">
                                        <img class="card-img" src="{{ url('gambar/' . $item->image) }}" alt="card" />
                ...
                <h4 class="pages3-tulis">Portofolio</h4>
                        ...
                        <div class="pages3-bungkusjajan">
                            ...
                            <div class="pages3-lamnjut">
                                <a href="/buat_microsite" class="pages3-lanjutkan">Kembali</a>
                                {{-- <button id="lanjut" class="pages3-lanjutkan submit-button">Lanjut</button> --}}
