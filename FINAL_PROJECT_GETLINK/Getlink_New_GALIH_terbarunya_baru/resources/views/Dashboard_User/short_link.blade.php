...
@section('konten')
                ...
                <div class="anim sl-content-isi">
                    ...
                    <div class="sl_bottom">
                        ...
                        <table class="data">
                            ...
                            <tr>
                                <td>1</td>
                                <td class="teks">https://github.com/milon/url-shortener</td>
                                <td class="teks" id="copy-text">http://localhost:8000/dshadsk</td>
                                <td>

                                    <div class="aksi-wrapper">

                                        <button onclick="copyText()" style="margin-right:5px; margin-bottom: 3px;"
                                            class="copy-btn">
                                            <i class="fa-regular fa-copy" style="color:#fff;"></i>
                                        </button>

                                        <button onclick="openModaledit()" style="margin-right:5px; margin-bottom: 3px;"
                                            class="edit-btn">
                                            <i class="fa-solid fa-pen" style="color:#fff;"></i>
                                        </button>

                                        <button style="margin-right:5px;" class="katHap" data-id="" data-nama=""
                        ...
                        <form class="bottomtab" action="" id="sl_edit" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="botSj">
                                <input type="text" name="subtitle" value="" placeholder="Subtitle 1" id=""
    ...
    <!-- Modal -->
    <div id="SlEditModal" class="modal">
        <div class="modal-content">
            <div class="slMtop">
                <p class="mtopP">Buat tautan</p>
