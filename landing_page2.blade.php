...
<body>
  ...
  <div class="almost_footer" style="height: 512px">
    ...
    <div class="box_foot_kiri">
      <div class="info">
        <div class="satu">
          ...
          <p> Jl.Anggrek No.200 Cepokomulyo <br> Kepanjen,Jawa Timur</p>
        </div>
        <div class="dua">
          <div class="image_footer me-2">
    ...
    <div class="box_foot_kanan">
      ...
      <a href="https://goo.gl/maps/rfH27e4GBKWS1qnD9"><img class="foot_lokasu_img" src="{{ asset('assets_landing_page/img/map.png') }} " alt="">
      </a>
    </div>
          <img class="garis_foot" src="{{ asset('assets_landing_page/img/Line 1.png') }} " alt="">
    <div class="foot_footer">
      <div class="foot_copyright" style="margin-top: 10px;">
