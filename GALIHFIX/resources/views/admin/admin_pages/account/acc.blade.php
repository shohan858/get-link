...
<script>
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        return '<button onclick="showDetail(' + row.id + ')" class="detail-btn"><i class="fas fa-info"></i></button>';
                    }
                }
            ]
        });
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $('#imgPreview').attr('src', response.data.img ? '/gambar/' + response.data.img : '{{ asset('assets/img/av.png') }}');
        ...
        <div class="anim profil-content-isi">
            ...
            <div class="profil_kiri">
              ...
              <form id="edit" class="profil_form">
                ...
                <input  value="" type="datetime-local" disabled name="created_at" id="created_at" class="profil_input">
                <label class="profil_label" for="email">Jumlah Microsite</label><br>
                <input  value="" type="number" disabled name="jumlah" id="jumlah_microsite" class="profil_input">
                <label class="profil_label" for="email">Jumlah Slot Microsite</label>
                <input  value="" type="number" disabled name="jumlah_slot" id="jumlah_slot" class="profil_input">
              </form>
            </div>
        </div>
    </div>
