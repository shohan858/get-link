                ...
                <div class="pages4-bagi">
                    ...
                    <div id="prew2" class="pages4-kanan">
                        ...
                        <div class="pages3-lamnjut-prew">
                            ...
                            <button style="margin: 0;" type="button" id="buat-micro" class="pages4-lanjutkan"
                                value="1" style="height:40px">
                                Selesai
                                <i class="fa-solid fa-chevron-right"></i>
                            </button>
                        </div>
    ...
    <script>
        function generateHTML() {
            ...
            if (background.type_background === 'color') {
                ...
                html += '<div class="bungkus" style="background-image: url(\'http://localhost:8000/microsite/background/' +
            ...
            data.forEach(function(i) {
                var code = i.code;
                var html_code = code.replace(/src="microsite\/medsos/g,
                    'src="http://localhost:8000/microsite/medsos/');
                html_code = html_code.replace(/src="microsite\/konten/g,
                    'src="http://localhost:8000/microsite/konten');
                if (i.id === 9) {
                    kolom2 += html_code;
                } else {
